...
**AI Disclaimer:** Open-weight local LLMs may be used to assist with development and maintaining the project, but all code is reviewed by humans and follows best practices.
