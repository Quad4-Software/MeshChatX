...
"""Reference tests for http uploads and error-response helpers."""
...
class TestReadFieldLimitedProperties:
    @pytest.mark.asyncio
...
class TestWriteFieldToPathProperties:
...
class TestHttpErrorFromExceptionProperties:
    ...
    def test_status_and_message(self, exc, fallback):
