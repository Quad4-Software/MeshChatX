...
"""Reference tests for interface enable/disable flag mutation."""
...
def test_enable_writes_flag_when_neither_key_present():
...
def test_disable_route_message_is_not_deleted():
