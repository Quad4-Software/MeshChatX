...
"""Property, reference, adversarial, and metamorphic tests for the translation pack manager.

These tests use independent references (path containment, regex invariants, round-trip
...
def _independent_filename_rejected(s):
    """Independent reference: a filename is unsafe if it is empty, ., .., hidden, or worse.
...
class TestPackManagerMetamorphic:
    @given(
...
class TestPackManagerAdversarial:
