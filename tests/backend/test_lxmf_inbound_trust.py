...
"""Regression and adversarial references for LXMF inbound trust hardening.
...
# ---------------------------------------------------------------------------
# Pure parser references (zenith + siblings)
# ---------------------------------------------------------------------------
...
def test_parse_lxmf_image_audio_file():
...
def test_parse_lxmf_stamp_cost(app_data_base64):
...
def test_reaction_hash(raw, expected_to):
...
def test_reaction_only_classifier():
