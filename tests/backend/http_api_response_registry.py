...
from tests.backend.http_api_response_schemas import (
    ...
    BUG_REPORT_ISSUE_SCHEMA,
    BUG_REPORT_ISSUES_SCHEMA,
    CHANGELOG_SCHEMA,
    ...
    DESTINATION_DELIVERY_DIAGNOSTICS_SCHEMA,
    ...
    FILESYNC_SHARED_SUGGESTION_SCHEMA,
...
HTTP_JSON_GET_CONTRACTS: tuple[HttpJsonContract, ...] = (
    ...
    HttpJsonContract("GET", "/api/v1/bug-reports/issues", BUG_REPORT_ISSUES_SCHEMA),
    HttpJsonContract(
        "GET",
        "/api/v1/bug-reports/issues/{fingerprint}",
        BUG_REPORT_ISSUE_SCHEMA,
        match_info={"fingerprint": "missing"},
    ...
    HttpJsonContract(
        "GET",
        "/api/v1/filesync/shared-directory-suggestion",
        FILESYNC_SHARED_SUGGESTION_SCHEMA,
        allow_statuses=(200, 400, 503),
        alt_schemas=(MESSAGE_ENVELOPE_SCHEMA,),
    ),
