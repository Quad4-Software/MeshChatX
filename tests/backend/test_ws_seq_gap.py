...
"""Reference tests for BroadcastSeqState.gap_hint."""
...
def expected_gap_hint(seq: int, since_seq: int) -> dict:
...
def test_gap_hint_matches_pure(stamps, since):
    import asyncio
    ...
    async def run():
        ...
        expected = expected_gap_hint(state.seq, since)
