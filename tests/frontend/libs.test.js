...
/**
 * Differential references against dayjs (devDependency) plus frozen golden
...
describe("libs references", () => {
    it("reference: formatDate equals dayjs for dense local calendar sampling", () => {
    ...
    it("reference: FROM_NOW_GOLDEN matches relativeLabel and fromNow", () => {
    ...
    it("reference: emitter semantics match mitt-style fanout and off-all", () => {
    ...
    it("reference: uuidv4 always validates as v4 and never collides in batch", () => {
    ...
    it("reference: no-crypto uuid path still RFC4122 v4", () => {
    ...
    it("reference: click-outside function form is equivalent to object form defaults", () => {
        const handler = () => {};
