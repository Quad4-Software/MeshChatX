...
| Auth / CSRF       | `csrf.py`, `app_security_settings.py`, `ip_allowlist.py`             | `auth/`                     | `http/ws/dispatch.py`        | `test_csrf*`, `test_access_attempts_*`                                                     | Auth gate in `App.vue`                                                                            |
...
| `features/call/CallPage.svelte`                                   | `features/call/components/`, `features/call/lib/`                    | overlay mounted from App.vue                 | call libs                           | `CallPage*.test.js`, `CallOverlay.test.js`                                       |
