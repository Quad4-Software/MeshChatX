---
name: rns-link-api
description: Generic RNS Link WebSocket transport and plugin rnsLink.* managers. Use when changing rns.link.* handlers, link cache, or plugin link permissions.
---
