...
- Announce intervals default to `constants.DEFAULT_ANNOUNCE_INTERVAL_SECONDS` (6 h) on every surface. Sub-hour defaults get throttled upstream. See `reticulum-zen.md` announce cadence for the migration rule.
