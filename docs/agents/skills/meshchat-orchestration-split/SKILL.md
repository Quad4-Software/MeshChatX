...
- `docs/agents/module-ownership.md`
- `docs/agents/conventions/backend.md`
...
7. Follow inventory names in `docs/agents/module-ownership.md`. Do not invent alternate folders.
