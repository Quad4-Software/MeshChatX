...
- When splitting or moving handlers among `routes/<domain>.py`, follow `docs/agents/skills/meshchat-orchestration-split/SKILL.md` and `docs/agents/module-ownership.md`. Mechanical moves only (no behaviour change in the same change).
