...
Preferred option (recommended): install from a release wheel (4.9.0 or newer),
...
Direct example (v4.9.0):

```bash
pipx install "https://github.com/Quad4-Software/MeshChatX/releases/download/v4.9.0/reticulum_meshchatx-4.9.0-py3-none-any.whl"
```
...
python -m pip install "https://github.com/Quad4-Software/MeshChatX/releases/download/v4.9.0/reticulum_meshchatx-4.9.0-py3-none-any.whl"
```
