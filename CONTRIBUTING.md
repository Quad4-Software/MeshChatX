...
| Frontend | Prettier (incl. Svelte), oxlint (JS/TS), ESLint, svelte-check, knip | task format:frontend, task lint:frontend (`task check:svelte` / `pnpm run format:check:svelte`) |
