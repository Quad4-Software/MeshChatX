    ...
    <div class="relative z-20 flex items-center gap-2 px-3 sm:px-4 py-2 border-b border-sem-border bg-sem-canvas">
        ...
        <div class="min-w-0 flex-1">
            ...
            <div class="text-xs text-sem-fg-muted mt-0.5 flex items-center gap-2 min-w-0">
                <div
                    class="cursor-pointer hover:text-sem-accent transition-colors truncate max-w-[min(40vw,12rem)] sm:max-w-none shrink-0"
...
export default {
    ...
    computed: {
        ...
        peerPathRowClass() {
            const base = "cursor-pointer hover:text-sem-fg hover:text-sem-fg";
            if (this.peerPathBusy) {
