            ...
            <div class="p-4 md:p-6 w-full max-w-5xl mx-auto">
                <div class="fused-panel">
                    ...
                    <div class="fused-section space-y-4">
                        ...
                        <div v-if="rules.length === 0" class="text-center py-12 text-sem-fg-muted">
                            {{ $t("forwarder.no_rules") }}
                        </div>
                        <div
                            v-for="rule in rules"
                            :key="rule.id"
                            class="flex items-center justify-between gap-4 py-4 border-b border-sem-border last:border-b-0"
                        >
