...
Preferred option (recommended): install from a release wheel,
...
Direct example (replace X.Y.Z with the release you want):

```bash
pipx install "https://github.com/Quad4-Software/MeshChatX/releases/download/vX.Y.Z/reticulum_meshchatx-X.Y.Z-py3-none-any.whl"
```
...
python -m pip install "https://github.com/Quad4-Software/MeshChatX/releases/download/vX.Y.Z/reticulum_meshchatx-X.Y.Z-py3-none-any.whl"
```
