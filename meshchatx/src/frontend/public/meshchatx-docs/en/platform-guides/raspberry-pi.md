...
Preferred option (recommended): install from a release wheel (4.8.3 or newer),
...
python -m pip install "https://github.com/Quad4-Software/MeshChatX/releases/download/v4.8.3/reticulum_meshchatx-4.8.3-py3-none-any.whl"
```
