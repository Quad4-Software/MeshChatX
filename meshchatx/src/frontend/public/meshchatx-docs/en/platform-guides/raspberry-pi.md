...
Preferred option (recommended): install from a release wheel (4.8.4 or newer),
...
Direct example (v4.8.4):

```bash
pipx install "https://github.com/Quad4-Software/MeshChatX/releases/download/v4.8.4/reticulum_meshchatx-4.8.4-py3-none-any.whl"
```
...
python -m pip install "https://github.com/Quad4-Software/MeshChatX/releases/download/v4.8.4/reticulum_meshchatx-4.8.4-py3-none-any.whl"
```
