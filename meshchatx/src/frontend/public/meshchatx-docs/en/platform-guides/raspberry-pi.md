...
Preferred option (recommended): install from a release wheel (4.8.5 or newer),
...
python -m pip install "https://github.com/Quad4-Software/MeshChatX/releases/download/v4.8.5/reticulum_meshchatx-4.8.5-py3-none-any.whl"
```
