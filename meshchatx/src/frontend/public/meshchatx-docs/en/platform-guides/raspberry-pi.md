...
Preferred option (recommended): install from a release wheel (4.8.7 or newer),
...
Direct example (v4.8.7):

```bash
pipx install "https://github.com/Quad4-Software/MeshChatX/releases/download/v4.8.7/reticulum_meshchatx-4.8.7-py3-none-any.whl"
```
...
python -m pip install "https://github.com/Quad4-Software/MeshChatX/releases/download/v4.8.7/reticulum_meshchatx-4.8.7-py3-none-any.whl"
```
