...
export const MESHCHAT_THEME_VARIABLES_LIGHT = {
    ...
    "--mc-action-primary-text": "#ffffff",
    "--mc-action-danger": "#dc2626",
    "--mc-action-danger-hover": "#ef4444",
    "--mc-action-danger-text": "#ffffff",
    "--mc-action-warning": "#ea580c",
    "--mc-action-warning-hover": "#f97316",
    "--mc-action-warning-text": "#ffffff",
    "--mc-action-success": "#16a34a",
    "--mc-action-success-hover": "#22c55e",
    "--mc-action-success-text": "#ffffff",
    "--mc-action-info": "#0284c7",
    "--mc-action-info-hover": "#0ea5e9",
    "--mc-action-info-text": "#ffffff",
...
export const MESHCHAT_THEME_VARIABLES_DARK = {
    ...
    "--mc-surface": "#09090b",
    "--mc-border": "#27272a",
    "--mc-border-card": "#18181b",
    "--mc-border-strong": "#3f3f46",
    "--mc-text": "#f3f4f6",
    "--mc-text-secondary": "#ffffff",
    "--mc-text-muted": "#a1a1aa",
    "--mc-text-label": "#e4e4e7",
    "--mc-focus": "#3b82f6",
    ...
    "--mc-action-info-hover": "#0ea5e9",
    "--mc-action-info-text": "#ffffff",
    "--mc-scrollbar-thumb": "#3f3f46",
    "--mc-scrollbar-track": "#09090b",
    "--mc-scrollbar-thumb-border": "#09090b",
    "--mc-glass-surface": "rgb(9 9 11 / 0.94)",
    "--mc-surface-muted": "rgb(24 24 27 / 0.9)",
    "--mc-surface-raised": "rgb(24 24 27 / 0.85)",
...
export function tailwindSemanticColorExtend() {
    return {
        ...
        "action-primary-text": "var(--mc-action-primary-text)",
        "action-danger": "var(--mc-action-danger)",
        "action-danger-hover": "var(--mc-action-danger-hover)",
        "action-danger-text": "var(--mc-action-danger-text)",
        "action-warning": "var(--mc-action-warning)",
        "action-warning-hover": "var(--mc-action-warning-hover)",
        "action-warning-text": "var(--mc-action-warning-text)",
        "action-success": "var(--mc-action-success)",
        "action-success-hover": "var(--mc-action-success-hover)",
        "action-success-text": "var(--mc-action-success-text)",
        "action-info": "var(--mc-action-info)",
        "action-info-hover": "var(--mc-action-info-hover)",
        "action-info-text": "var(--mc-action-info-text)",
        focus: "var(--mc-focus)",
