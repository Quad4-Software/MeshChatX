...
class MicrophoneRecorder {
    declare _scriptProcessorCapture: boolean;
    declare _workletBlobUrl: any;
    declare audioContext: any;
    declare channels: number;
    declare microphoneMediaStream: any;
    declare pcmChunks: any[];
    declare processorNode: any;
    declare sampleRate: number;
    declare silentGainNode: any;
