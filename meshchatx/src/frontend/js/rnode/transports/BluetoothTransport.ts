...
export default class BluetoothTransport extends Transport {
    declare _disconnectedHandler: any;
    declare _notifyHandler: any;
    declare _readableController: any;
    declare device: any;
    declare env: any;
    declare gattServer: any;
    declare readable: any;
    declare rxCharacteristic: any;
    ...
    async open() {
        if (!this.device.gatt) {
            ...
            (err as Error & { code?: string; status?: number; body?: unknown }).code = "GATT_UNAVAILABLE";
            throw err;
        }
        ...
        try {
            ...
            (err as Error & { code?: string; status?: number; body?: unknown }).code = "NUS_SERVICE_NOT_FOUND";
            err.cause = cause;
        ...
        try {
            ...
            (err as Error & { code?: string; status?: number; body?: unknown }).code = "NUS_CHARACTERISTICS_MISSING";
            err.cause = cause;
            await this._safeDisconnect();
            throw err;
        }
