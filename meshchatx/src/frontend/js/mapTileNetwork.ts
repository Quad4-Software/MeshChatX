...
export async function fetchWithTimeout(resource, init: any = {}, timeoutMs = TILE_FETCH_TIMEOUT_MS) {
...
export async function fetchTileBlobWithRetry(url, init: any = {}, options: any = {}) {
...
export async function fetchJsonWithRetry(url, init: any = {}, options: any = {}) {
