...
export function showBootSplashFatalError(payload) {
    ...
    const title = splash.querySelector("[data-boot-title]");
    if (title && record.title) {
        title.textContent = record.title;
        title.hidden = false;
    }

    const details = splash.querySelector("[data-boot-details]");
    if (details) {
    ...
    const actions = splash.querySelector("[data-boot-actions]");
    if (actions) {
