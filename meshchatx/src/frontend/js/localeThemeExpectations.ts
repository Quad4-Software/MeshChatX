...
/**
 * Independent references for UI locale and theme invariants.
...
export function expectedBootTheme(storedTheme: string | null | undefined, prefersDark = false): ExpectedBootTheme {
...
export function expectedVisualiserClearColor(dark: boolean): RgbaColor {
    if (dark) {
...
export function expectedVisualiserIsDark(configTheme: string | null | undefined, htmlHasDarkClass: boolean): boolean {
...
export function expectedUiLocalePack(raw: unknown): string {
