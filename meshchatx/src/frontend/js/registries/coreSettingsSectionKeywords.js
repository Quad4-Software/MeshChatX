...
export const CORE_SETTINGS_SECTION_KEYWORDS = {
    ...
    nomadRenderer: [
        ...
        "settings.nomad_micron_wasm_title",
        "micron",
    ],
    crawler: [
        "Discovery",
    ...
    appearance: [
        ...
        "app.system_theme",
        "app.theme_preset",
        "app.theme_preset_default",
        "app.theme_preset_high_contrast",
        "app.theme_preset_oled",
        "app.theme_preset_solarized",
        "app.theme_preset_nord",
        "app.theme_preset_gruvbox",
        "app.theme_preset_catppuccin",
        "app.theme_preset_dracula",
        "app.theme_preset_rose_pine",
        "app.theme_preset_forest",
        "app.theme_preset_midnight",
        "app.theme_preset_warm_paper",
        ...
        "app.live_preview",
        "app.realtime",
        "app.app_sidebar_layout",
        "app.app_sidebar_layout_description",
        "sidebar",
        "glass",
        "transparency",
        "grouped",
    ...
    location: [
        ...
        "MBTiles",
        "nominatim",
        "app.map_tiles_heading",
        "app.map_offline_enabled",
        "app.map_tile_cache_enabled",
        "app.map_tile_server_url",
        "app.map_nominatim_api_url",
        "app.map_defaults_heading",
        "app.map_overlay_limits_heading",
    ],
    privacyData: [
