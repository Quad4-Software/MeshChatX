...
class KeyboardShortcuts {
    declare activeKeys: Set<any>;
    declare isRecording: boolean;
    declare onRecordCallback: any;
    ...
    matches(shortcutKeys, e) {
        ...
        const codeMatch =
            (e as Error & { code?: string; status?: number; body?: unknown }).code === `Digit${mainKey}` ||
            (e as Error & { code?: string; status?: number; body?: unknown }).code === `Key${mainKey.toUpperCase()}` ||
            (e as Error & { code?: string; status?: number; body?: unknown }).code === mainKey.toUpperCase(); // For keys like 'Enter', 'Escape'
