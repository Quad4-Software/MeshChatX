...
<script lang="ts">
    ...
    import {
        DEFAULT_RNX_EXECUTE_FORM,
        DEFAULT_RNX_LISTEN_FORM,
        RNX_VIEW_TABS,
    ...
    async function loadSessions(): Promise<void> {
        try {
            ...
            ToastUtils.error(
                error?.response?.data?.message || t("rnx.failed_to_load_sessions")
            );
        }
    }
    ...
    async function createExecuteSession(): Promise<void> {
        ...
        try {
            ...
            ToastUtils.error(
                error?.response?.data?.message || t("rnx.failed_to_create_session")
            );
        }
    }
    ...
    async function startSelected(): Promise<void> {
        ...
        try {
            ...
            ToastUtils.error(
                error?.response?.data?.message || t("rnx.failed_to_start_session")
            );
        }
    }
    ...
    async function stopSelected(): Promise<void> {
        ...
        try {
            ...
            ToastUtils.error(
                error?.response?.data?.message || t("rnx.failed_to_stop_session")
            );
        }
    }
    ...
    async function removeSelected(): Promise<void> {
        ...
        try {
            ...
            ToastUtils.error(
                error?.response?.data?.message || t("rnx.failed_to_remove_session")
            );
        }
    }
    ...
    async function clearSelectedOutput(): Promise<void> {
        ...
        try {
            ...
            ToastUtils.error(
                error?.response?.data?.message || t("rnx.failed_to_clear_output")
            );
        }
    }
    ...
    async function sendCommand(): Promise<void> {
        ...
        try {
            ...
            ToastUtils.error(
                error?.response?.data?.message || t("rnx.failed_to_send_input")
            );
        }
    }
