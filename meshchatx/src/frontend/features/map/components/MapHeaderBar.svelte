...
{#if !embedded}
    ...
    >
        <MaterialDesignIcon iconName="map" class="size-6 text-blue-500 dark:text-blue-400 shrink-0" />
...
<div
    class="flex flex-wrap items-center gap-x-1.5 gap-y-2 px-3 py-2 sm:px-4 border-b border-sem-border bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm z-10 relative sm:justify-end min-w-0"
>
