...
<Modal
    {open}
    title="Raw LXMF Message"
    maxWidth={672}
    bodyClass="p-0 overflow-y-auto bg-gray-50 dark:bg-zinc-950"
    onClose={() => onclose?.()}
>
    <div class="p-6 space-y-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div class="space-y-1">
                <div class="text-[10px] font-bold uppercase tracking-wider text-sem-fg-muted">Message ID</div>
        ...
        <div class="space-y-1">
            ...
            <div class="text-sm font-mono break-all text-sem-fg bg-sem-surface p-2 rounded-sm border border-sem-border">
                {rawMessageData.hash}
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div class="space-y-1">
                <div class="text-[10px] font-bold uppercase tracking-wider text-sem-fg-muted">Source Hash</div>
                <div class="text-xs font-mono break-all text-sem-fg">{rawMessageData.source_hash}</div>
            </div>
            <div class="space-y-1">
                <div class="text-[10px] font-bold uppercase tracking-wider text-sem-fg-muted">Destination Hash</div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="space-y-1">
                    ...
                    <div class="text-sm text-sem-fg wrap-break-word">
                        {rawMessageData.path_interface_at_send != null && rawMessageData.path_interface_at_send !== ""
                ...
                <div class="space-y-1">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        {#if rawMessageData.path_row_hash_hex}
                            <button
                                type="button"
                                class="text-xs text-sem-accent hover:underline shrink-0 focus-ring-sem"
        ...
        <div class="space-y-1">
            <div class="text-[10px] font-bold uppercase tracking-wider text-sem-fg-muted">Content / App Data</div>
            {#if !isBodyOversized}
                <div
        ...
        {#if rawMessageData.raw_uri}
            <div class="space-y-1">
                <div class="text-[10px] font-bold uppercase tracking-wider text-sem-fg-muted">Raw LXMF URI</div>
                <div
        ...
        <details class="group">
            ...
            >
                <MaterialDesignIcon iconName="chevron-right" class="size-4 group-open:rotate-90 transition-transform" />
