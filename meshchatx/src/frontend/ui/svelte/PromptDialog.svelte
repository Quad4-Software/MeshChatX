...
>
    <Dialog.Portal>
        <Dialog.Overlay class="fixed inset-0 z-9998 bg-black/50 backdrop-blur-xs" />
        {#if open}
                    ...
                    <div class="p-8">
                        <div class="flex items-start mb-6">
                            ...
                            <div class="flex-1 min-w-0">
                                <Dialog.Title level={3} class="text-xl font-black text-sem-fg mb-2">
                                    {t("common.prompt_title")}
                                </Dialog.Title>
                                <Dialog.Description class="text-sem-fg-muted whitespace-pre-wrap leading-relaxed">
