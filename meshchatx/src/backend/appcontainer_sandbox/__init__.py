...
_grant_window_object_access = _core._grant_window_object_access
_is_sandbox_init_failure = _core._is_sandbox_init_failure
...
_SE_WINDOW_OBJECT = _core._SE_WINDOW_OBJECT
_READ_CONTROL = _core._READ_CONTROL
_WRITE_DAC = _core._WRITE_DAC
...
_SANDBOX_INIT_FAILURE_CODES = _core._SANDBOX_INIT_FAILURE_CODES
_SANDBOX_INIT_FAILURE_WINDOW = _core._SANDBOX_INIT_FAILURE_WINDOW
