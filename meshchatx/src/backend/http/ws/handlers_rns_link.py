...
HANDLERS = {
    "rns.link.open": handle_rns_link_open,
    "rns.link.identify": handle_rns_link_identify,
    "rns.link.request": handle_rns_link_request,
    "rns.link.send": handle_rns_link_send,
    "rns.link.close": handle_rns_link_close,
}
