...
def register_reticulum_instance_config_routes(routes, app):
    ...
    @routes.get("/api/v1/reticulum/config/versions")
    ...
    @routes.get("/api/v1/reticulum/config/versions/{version_id}")
    ...
    @routes.post("/api/v1/reticulum/config/versions/{version_id}/restore")
