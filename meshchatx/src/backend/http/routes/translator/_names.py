...
"""Shared imports for translator HTTP route slices."""
...
def parse_translator_timeout(raw, *, default=None):
...
async def read_translator_timeout_raw(request, default=None):
